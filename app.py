...
app = Flask(__name__, template_folder= os.path.join(project_path, "templates" + os.path.sep))
app.config['EXPLAIN_TEMPLATE_LOADING'] = True
app.config['UPLOAD_FOLDER'] = os.path.join(project_path, 'downloaded_files' + os.path.sep)
